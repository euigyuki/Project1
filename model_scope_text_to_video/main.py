...
try:
    ...
    prompt = "a woman is drinking coffe in a cafe"
    ...
    # Ensure frames are in the correct shape and type
    ...
    # Process all frames
    video_frames = process_frame(output.frames[0])  # Assuming all frames are in the first element
