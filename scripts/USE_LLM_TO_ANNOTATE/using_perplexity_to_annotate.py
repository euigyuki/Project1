...
def main():
    ...
    try:
        api_key = "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"  # Your actual API key
        client = get_perplexity_client(api_key)

        captions = load_captions("captions3.txt")
        results = []
        ...
        with open("perplexity_annotations.json", "w") as f:
